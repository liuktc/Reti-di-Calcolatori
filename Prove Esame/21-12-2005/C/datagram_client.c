...
int main(int argc, char **argv) {
    ...
    printf("Dammi il nome della stanza per sospenderla, EOF per terminare: ");
    while(gets(nomeStanza)){
        // Fai qualcosa con nome file ed eventualmente altre gets
        ...
        if (ris < 0) {
            printf("Errore: stanza inesistente o gia sospesa\n");
        } else {
